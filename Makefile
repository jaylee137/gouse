...
count:
	@echo "Counting lines..."
	bash count.sh public/count.svg true 13708a array cache chart crypto console date function helper io log math net number regex strings structs tools types
	@echo "Done!"
